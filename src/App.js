        ...
        <>
            <Container className="my-4">
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(300px,1fr))", gap: "1rem", alignItems: "flex-start", }}>
                    ...
                    return(<BudgetCard gray key={budget.id} name={budget.name} amount={amount} max={budget.max}
                    ...
                    <UncategorizedBudgetCard 
                     ...
                     onViewExpenseClick={()=>setViewExpensesModalBudgetId(UNCATEGORIZED_BUDGET_ID.id)}/>
                    <TotalBudgetCard/>
                </div>
            </Container>
